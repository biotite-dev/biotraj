...
from biotraj.utils import cast_indices, in_units_of
...
def load_arc(filename, stride=None, atom_indices=None, frame=None):
    ...
    See Also
    --------
    biotraj.ArcTrajectoryFile :  Low level interface to TINKER .arc files
    """
...
class ArcTrajectoryFile:
    ...
    def _read(self):
        "Read a single frame"
        from biotraj.core.element import Element, virtual
