...
from biotraj.core.element import virtual_site
from biotraj.core.topology import Topology
from biotraj.formats.registry import FormatRegistry
from biotraj.utils import cast_indices, ensure_type, lengths_and_angles_to_tilt_factors
...
def hoomdtraj_to_traj(
    ...
    Returns
    --------
    traj : biotraj.Trajectory object
...
def _process_bonds(top):
    ...
    unique_bond_types = list({f"{b[0]}-{b[1]}" for b in sorted_bond_types})
