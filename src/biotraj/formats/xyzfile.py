...
from biotraj.utils import cast_indices, ensure_type, in_units_of, open_maybe_zipped
from biotraj.version import version
...
def load_xyz(filename, top=None, stride=None, atom_indices=None, frame=None):
    ...
    See Also
    --------
    biotraj.XYZTrajectoryFile :  Low level interface to xyz files
    """
