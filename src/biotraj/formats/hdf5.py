...
def load_hdf5(filename, stride=None, atom_indices=None, frame=None):
    ...
    See Also
    --------
    biotraj.HDF5TrajectoryFile :  Low level interface to HDF5 files
    """
...
class HDF5TrajectoryFile:
    ...
    See Also
    --------
    biotraj.load_hdf5 : High-level wrapper that returns a ``md.Trajectory``
    """
    ...
    def topology(self, topology_object):
        ...
        Parameters
        ----------
        topology_object : biotraj.Topology
            A topology object
        """
        _check_mode(self.mode, ("w", "a"))
