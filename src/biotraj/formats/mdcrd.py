...
from biotraj.utils.unit import in_units_of
from biotraj.utils.validation import cast_indices, ensure_type
...
def load_mdcrd(filename, top=None, stride=None, atom_indices=None, frame=None):
    ...
    See Also
    --------
    biotraj.MDCRDTrajectoryFile :  Low level interface to MDCRD files
    """
            ...
            if i == self._n_atoms * 3:
                ...
                if len(peek) == 3:
                    ...
                    if self._has_box is True:
                        raise OSError("Box information not found in file.")
