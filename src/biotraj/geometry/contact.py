...
def compute_contacts(
    ...
    ----------
    traj : md.Trajectory
        An biotraj trajectory. It must contain topology information.
    ...
    See Also
    --------
    biotraj.geometry.squareform : turn the result from this function
...
def squareform(distances, residue_pairs):
    ...
    See Also
    --------
    biotraj.compute_contacts : Compute the array of contact distances
    """
