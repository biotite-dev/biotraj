...
from biotraj.geometry.angle import compute_angles
from biotraj.geometry.dihedral import compute_dihedrals
from biotraj.geometry.distance import compute_distances
from biotraj.utils import import_
from biotraj.utils.six.moves import filter, xrange  # itertools
...
def get_nonredundant_internal_coordinates(trajectory, conformation, get_operator=False):
    ...
    conformation : biotraj.Trajectory
