...
from biotraj.utils.unitcell import box_vectors_to_lengths_and_angles
...
def compute_center_of_mass(traj, select=None):
    ...
    select : str, optional, default=all
        a biotraj.Topology selection string that
