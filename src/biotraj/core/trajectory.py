...
def load_frame(filename, index, top=None, atom_indices=None, **kwargs):
    ...
    >>> print first_frame
    <biotraj.Trajectory with 1 frames, 22 atoms>
...
def load(filename_or_filenames, discard_overlapping_frames=False, **kwargs):
    ...
    >>> print traj3
    <biotraj.Trajectory with 500 frames, 2 atoms at 0x18236e4a0>
...
def iterload(filename, chunk=100, **kwargs):
    ...
    ...    print chunk
    <biotraj.Trajectory with 100 frames, 423 atoms at 0x110740a90>
    <biotraj.Trajectory with 100 frames, 423 atoms at 0x110740a90>
    <biotraj.Trajectory with 100 frames, 423 atoms at 0x110740a90>
    <biotraj.Trajectory with 100 frames, 423 atoms at 0x110740a90>
    <biotraj.Trajectory with 100 frames, 423 atoms at 0x110740a90>
...
class Trajectory:
    ...
    <biotraj.Trajectory with 1000 frames, 22 atoms at 0x1058a73d0>

    >>> # slicing a trajectory
    >>> t = md.load('trajectory.h5')
    >>> print(t)
    <biotraj.Trajectory with 100 frames, 22 atoms>
    >>> print(t[::2])
    <biotraj.Trajectory with 50 frames, 22 atoms>
    ...
    See Also
    --------
    biotraj.load : High-level function that loads files and returns an ``md.Trajectory``
    ...
    def _string_summary_basic(self):
        ...
        value = "biotraj.Trajectory with %d frames, %d atoms, %d residues, %s" % (
            self.n_frames,
            self.n_atoms,
            self.n_residues,
            unitcell_str,
    ...
    def stack(self, other, keep_resSeq=True):
        ...
        keep_resSeq : bool, optional, default=True
            see ```biotraj.core.topology.Topology.join``` method documentation
